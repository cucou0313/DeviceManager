...
app = Flask(__name__)
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:/Users/zilong/python_project/tests/lcg.db' #绝对路径
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///DeviceManager.db'  # 相对路径
